...
class TestReference(unittest.TestCase):
    ...
    def test_generate_citation_key(self):
        ...
        self.assertEqual(self.test_ref.generate_citation_key(), 'Martti08')
    
    def test_generate_citation_key_multiple_auth(self):
        test_ref2 = Reference("book", **{"author":"Martti and Matti", "title":"titled","year":"2008","publisher":"publ"})
        self.assertEqual(test_ref2.generate_citation_key(), 'MM08')
    
    def test_str(self):
        self.test_ref.generate_citation_key()
        self.assertEqual(str(self.test_ref), ', book:\nauthor = Martti\ntitle = titled\nyear = 2008\npublisher = publ\nNo tags associated.\n')
